...
class Booking extends CI_Controller {
    ...
    public function info()
    {
        ...
        $data['items'] = $this->db->query("SELECT * FROM booking bo JOIN booking_detail d ON d.id_booking = bo.id_booking JOIN buku bu ON bu.id = d.id_buku WHERE bo.id_user = '$where'")->result_array();
